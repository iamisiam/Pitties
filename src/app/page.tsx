    ...
    <main className="min-h-screen bg-neutral-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link href="/simple" className="block p-6 bg-neutral-800 rounded-lg hover:bg-neutral-700 transition-colors">
          ...
          <Link href="/medium" className="block p-6 bg-neutral-800 rounded-lg hover:bg-neutral-700 transition-colors">
          ...
          <Link href="/complex" className="block p-6 bg-neutral-800 rounded-lg hover:bg-neutral-700 transition-colors">
